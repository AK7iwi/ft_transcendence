...
//               				</div>
//               				<p class="text-sm text-gray-300">Change your avatar</p>
//               				<label class="px-3 py-1 bg-gradient-to-r from-white via-pink-100 to-purple-200 text-slate-900 hover:opacity-90 rounded-full transition cursor-pointer">Choose File
//                 				<input type="file" accept="image/*" class="hidden" />
//               				</label>
//               				<button id="logout-button" class="px-3 py-1 bg-gradient-to-r from-red-500 via-red-600 to-red-700 text-white rounded-full transition hover:opacity-90">Logout</button>
//               				${this.successMessage ? `<div class="text-green-500 font-bold">${this.successMessage}</div>` : ''}
//               				${this.errorMessage ? `<div class="text-red-500 font-bold">${this.errorMessage}</div>` : ''}
//             			</div>
//           			</div>
