    	...
    	return `
      		<div class="mb-2">
        		...
        		<div class="p-[2px] rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
          			<input type="${type}" name="${name}" value="${value}" placeholder="${label}" class="w-full px-4 py-2 rounded-full bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-0" oninput="${onInput}" />
        		</div>
      		</div>
    	`;
  	}
