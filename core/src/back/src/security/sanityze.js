...
class Security {
    static async xssProtection(request, reply) {
    ...
    static async sqlInjectionProtection(request, reply) {
    ...
    static async securityMiddleware(request, reply) {
        await this.xssProtection(request, reply);
        await this.sqlInjectionProtection(request, reply);
    }
}
