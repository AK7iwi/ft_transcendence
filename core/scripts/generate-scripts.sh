...
mkdir -p "$SRCS_DIR/back/src/service/user/src/internal"
mkdir -p "$SRCS_DIR/back/src/service/auth/src/internal"
mkdir -p "$SRCS_DIR/back/src/service/friend/src/internal"

mkdir -p "$SRCS_DIR/back/src/service/user/src/database/db_models"
mkdir -p "$SRCS_DIR/back/src/service/auth/src/database/db_models"
mkdir -p "$SRCS_DIR/back/src/service/friend/src/database/db_models"
...
cp "$TEMP_CERTS_DIR/key.pem" "$SRCS_DIR/back/src/gateway/certs/"
cp "$TEMP_CERTS_DIR/cert.pem" "$SRCS_DIR/back/src/gateway/certs/"

# Set proper permissions for certificates in destination directories
chmod 600 "$SRCS_DIR/back/src/gateway/certs/key.pem"
chmod 644 "$SRCS_DIR/back/src/gateway/certs/cert.pem"
...
cp -r "$SRCS_DIR/back/internal/"* "$SRCS_DIR/back/src/service/user/src/internal/"
cp -r "$SRCS_DIR/back/internal/"* "$SRCS_DIR/back/src/service/auth/src/internal/"
cp -r "$SRCS_DIR/back/internal/"* "$SRCS_DIR/back/src/service/friend/src/internal/"

# Set proper permissions for internal files
find "$SRCS_DIR/back/src/service/user/src/internal" -type f -exec chmod 644 {} \;
find "$SRCS_DIR/back/src/service/auth/src/internal" -type f -exec chmod 644 {} \;
find "$SRCS_DIR/back/src/service/friend/src/internal" -type f -exec chmod 644 {} \;

# Copy database files to all services
cp -r "$SRCS_DIR/back/db_models/"* "$SRCS_DIR/back/src/service/user/src/database/db_models/"
cp -r "$SRCS_DIR/back/db_models/"* "$SRCS_DIR/back/src/service/auth/src/database/db_models/"
cp -r "$SRCS_DIR/back/db_models/"* "$SRCS_DIR/back/src/service/friend/src/database/db_models/"

# Set proper permissions for database files
find "$SRCS_DIR/back/service/user/src/database/db_models" -type f -exec chmod 644 {} \;
find "$SRCS_DIR/back/src/service/auth/src/database/db_models" -type f -exec chmod 644 {} \;
find "$SRCS_DIR/back/src/service/friend/src/database/db_models" -type f -exec chmod 644 {} \;
